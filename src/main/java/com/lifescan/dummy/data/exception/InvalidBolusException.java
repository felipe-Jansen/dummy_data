...
/** InvalidBolusException class for invalid loginid */
public class InvalidBolusException extends RuntimeException {

  private static final long serialVersionUID = 1L;
  private static final String MSG = "INVALID_BOLUS_EXCEPTION";

  /** constructor with custom message */
  public InvalidBolusException() {
    super(MSG);
  }
}
